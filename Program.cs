...
using (var context = new MyContext())
{
    ...
    {
        Console.WriteLine($" ID:{stdnt.ID}, Name: {stdnt.FirstMidName},Phone :{stdnt.PhoneNumber}" );
    }
    ...
    string updateSql = "UPDATE Students SET  PhoneNumber = '0349999999' WHERE FirstMidName = 'Muhammad'";
